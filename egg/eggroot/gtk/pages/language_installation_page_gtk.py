...
class language_installation_page_gtk(BasePageGtk):
    ...
    def __init__(self, language_manager, config_general):
        ...
        self._config_general["language_installation_page"]["locale"] = default_locales[2]
    ...
    def on_row_select_language(self, lbox, newrb=None):
        ...
        if child == self._components.get_component("more_button_language_win"):
            ...
            return
        self._config_general["language_installation_page"]["locale"] = child.lc_code
        self._config_general["language_installation_page"]["locale_sz"] = child.dname
    ...
    def on_row_select_keyboard(self, lbox, newrb=None):
        ...
        if child == self._components.get_component("more_button_keyboard_win"):
            ...
            return
        self._config_general["language_installation_page"]["keyboard"] = child.kb
        self._config_general["language_installation_page"]["keyboard_sz"] = child.dname
        try:
    ...
    def do_expensive_init(self):
        ...
        for lc in default_locales:
            self._components.get_component("listbox_language_win").add(LcLabel(lc))
    ...
    def init_view_keyboard(self):
        ...
        items = GnomeDesktop.parse_locale(self._config_general["language_installation_page"]["locale"])
        if items[0]:
            lang = items[1]
            country = items[2]
        else:
        ...
        l = self._config_general["language_installation_page"]["locale"]
    ...
    def refresh_ui_language(self):
        self._components.get_component("label_language_win").set_markup(u"<span font-size='medium'>{}</span>".format(self._language_manager.print_in_lang("language_installation_page", "desc_language")))
        self._components.get_component("label_keyboard_win").set_markup(u"<span font-size='medium'>{}</span>".format(self._language_manager.print_in_lang("language_installation_page", "desc_keyboard")))
        self._components.get_component("input_keyboard_win").set_placeholder_text(self._language_manager.print_in_lang("language_installation_page", "input_keyboard"))
        
    #title
    def get_title(self):
        return self._language_manager.print_in_lang("language_installation_page", "title")

    #sidebar
    def get_sidebar_title(self):
        return self._language_manager.print_in_lang("language_installation_page", "sidebar_title")
