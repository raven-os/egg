...
class LanguageManagement(object):
    def __init__(self, locales_folder=None, lang=None, file=None):
        ...
        if lang is not None and file is not None and locales_folder is not None:
